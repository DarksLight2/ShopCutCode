...
@section('content')
    <div class="max-w-[640px] mt-12 mx-auto p-6 xs:p-8 md:p-12 2xl:p-16 rounded-[20px] bg-purple">
        ...
        <x-forms.auth-form title="Забыли пароль" action="{{ route('auth.forgot-password.handle') }}">
            ...
            <x-slot:buttons>
                <div class="space-y-3 mt-5">
                    <div class="text-xxs md:text-xs"><a href="{{ route('auth.sign-in') }}"
                                                        class="text-white hover:text-white/70 font-bold">Авторизация</a>
                    </div>
                    <div class="text-xxs md:text-xs"><a href="{{ route('auth.sign-up') }}"
