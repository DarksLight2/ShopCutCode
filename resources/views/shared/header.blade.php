        ...
        <div class="header-inner flex items-center justify-between lg:justify-start">
            ...
            <div class="header-actions flex items-center gap-3 md:gap-5">
                    ...
                    <div x-data="{dropdownProfile: false}" class="profile relative">
                        ...
                        >
                            ...
                            <div class="flex items-center mt-3">
                                ...
                                <span class="ml-3 text-xs md:text-sm font-bold">{{ \Illuminate\Support\Facades\Auth::user()->name }}</span>
                            </div>
                            <div class="mt-4">
                                <ul class="space-y-2">
                ...
                @else
                    ...
                    <a href="{{ route('auth.sign-in') }}" class="profile hidden xs:flex items-center">
