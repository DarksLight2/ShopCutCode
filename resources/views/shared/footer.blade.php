            ...
            <div class="footer-logo order-0 basis-full sm:basis-1/2 lg:basis-1/3 shrink-0 text-center sm:text-left">
                <a href="{{ route('home') }}" class="inline-block" rel="home">
                    <img src="{{ \Illuminate\Support\Facades\Vite::asset('resources/images/logo.svg', null) }}"
                         class="w-[155px] h-[38px]" alt="CutCode">
                </a>
            </div><!-- /.footer-logo -->
                ...
                <div class="flex flex-wrap items-center justify-center sm:justify-end space-x-6">
                    <a href="#" class="inline-flex items-center text-white hover:text-pink" target="_blank"
                       rel="nofollow noopener">
                        <img class="h-5 lg:h-6"
                             src="{{ \Illuminate\Support\Facades\Vite::asset('resources/images/icons/youtube.svg', null) }}"
                             alt="YouTube">
                    ...
                    <a href="#" class="inline-flex items-center text-white hover:text-pink" target="_blank"
                       rel="nofollow noopener">
                        <img class="h-5 lg:h-6"
                             src="{{ \Illuminate\Support\Facades\Vite::asset('resources/images/icons/telegram.svg', null) }}"
                             alt="Telegram">
